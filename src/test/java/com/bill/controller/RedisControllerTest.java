...
public class RedisControllerTest {
    ...
    void queryTodoEqual() throws Exception {
        ...
        TodoListQueryResDto resDto = initQueryTodoTest("/redis/1", new TypeReference<TodoListQueryResDto>(){});
    ...
    void queryTodoList() throws Exception {
        ...
        List<TodoListQueryResDto> resDtoList = initQueryTodoTest("/redis", new TypeReference<List<TodoListQueryResDto>>(){});
